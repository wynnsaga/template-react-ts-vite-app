                ...
                {packageManagers.map((pm, index) => (
                  <div key={pm} className='flex items-center'>
                    ...
                    <Button
                      ...
                      {packageManager === pm && (
                        <motion.div
                          className='absolute inset-x-0 bottom-[1px] mx-auto h-0.5 w-[90%] bg-neutral-900 dark:bg-neutral-50'
                          layoutId='activeTab'
                          initial={false}
                          transition={{
                            type: 'spring',
        ...
        <div className='relative flex items-center'>
          <div className='min-w-[300px] grow font-mono'>
            {highlightedCode ? (
              ...
              <pre className='rounded-md border border-neutral-200 bg-white p-2 px-4 font-mono dark:bg-black dark:border-neutral-800'>
                {command}
              </pre>
            )}
          </div>
